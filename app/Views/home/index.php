...
<?= $this->section('content') ?>
	...
	<div class="d-flex flex-column flex-column-fluid container-fluid">
		...
		<div class="content flex-column-fluid" id="kt_content">
            ...
            <div class="d-flex flex-column flex-lg-row gap-2 gap-lg-5 h-100">
                <div class="col">
                    <div class="card bg-primary min-h-150px">
                        <div class="card-body align-content-center">
                            <div class="d-flex gap-2 align-items-center justif">
                                <div class="col-4">
                                    ...
                                    <span class="svg-icon svg-icon-white svg-icon-5hx">
                                ...
                                <div class="col">
                                    <h1 class="fs-1 fw-bold text-white"><?= @$division ? $division : 0; ?></h1>
                                    <h2 class="fs-2 fw-semibold text-white">Divisions</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card bg-success min-h-150px">
                        <div class="card-body align-content-center">
                            <div class="d-flex gap-2 align-items-center justif">
                                <div class="col-4">
                                    <!--begin::Svg Icon | path: /var/www/preview.keenthemes.com/keenthemes/metronic/docs/core/html/src/media/icons/duotune/finance/fin001.svg-->
                                ...
                                <div class="col">
                                    <h1 class="fs-1 fw-bold text-white"><?= @$employee ? $employee : 0; ?></h1>
                                    <h2 class="fs-2 fw-semibold text-white">Employees</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card bg-warning min-h-150px">
                        <div class="card-body align-content-center">
                            <div class="d-flex gap-2 align-items-center justif">
                                <div class="col-4">
                                    <!--begin::Svg Icon | path: /var/www/preview.keenthemes.com/keenthemes/metronic/docs/core/html/src/media/icons/duotune/finance/fin001.svg-->
                                ...
                                <div class="col">
                                    <h1 class="fs-1 fw-bold text-white"><?= @$presence ? $presence : 0; ?></h1>
                                    <h2 class="fs-2 fw-semibold text-white">Presences</h2>
                                </div>
                            </div>
                        </div>
                    </div>
